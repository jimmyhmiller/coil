...
dep_roots=['coil.compiler.ast.Program','coil.compiler.ast.StructDef','coil.compiler.ast.SumDef','coil.compiler.ast.Func']
...
'''
dep_wrappers=''
for name,t in zip(('program!','struct!','sum!','func!'),dep_roots):
